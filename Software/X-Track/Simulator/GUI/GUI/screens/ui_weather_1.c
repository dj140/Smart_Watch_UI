...
void ui_weather_1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_city_gruop_1, -39);
    lv_obj_set_y(ui_city_gruop_1, -407);
    ...
    lv_obj_set_x(ui_weather_title_group_3, 3);
    lv_obj_set_y(ui_weather_title_group_3, -85);
    ...
    lv_obj_set_x(ui_label_degree, -32);
    lv_obj_set_y(ui_label_degree, 55);
    ...
    lv_obj_set_x(ui_rain_group, 11);
    lv_obj_set_y(ui_rain_group, -45);
    ...
    lv_obj_set_x(ui_wind_group, 97);
    lv_obj_set_y(ui_wind_group, -47);
