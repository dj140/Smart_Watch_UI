...
void ui_watch_analog_screen_init(void)
{
    ...
    ui_clock_min = lv_label_create(ui_watch_analog);
    lv_obj_set_width(ui_clock_min, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_clock_min, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_clock_min, 30);
    lv_obj_set_y(ui_clock_min, 75);
    lv_obj_set_align(ui_clock_min, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_clock_min, "27");
    lv_obj_set_style_text_color(ui_clock_min, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_clock_min, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_clock_min, &ui_font_H1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_battery_group1, 1);
    lv_obj_set_y(ui_battery_group1, 2);

    ui_date_group2 = lv_obj_create(ui_watch_analog);
    lv_obj_set_width(ui_date_group2, 100);
    lv_obj_set_height(ui_date_group2, 82);
    lv_obj_set_x(ui_date_group2, 2);
    lv_obj_set_y(ui_date_group2, 273);
    ...
    lv_obj_set_x(ui_weather_group_5, -86);
    lv_obj_set_y(ui_weather_group_5, 2);
    ...
    ui_step_group2 = ui_stepgroup1_create(ui_watch_analog);
    lv_obj_set_x(ui_step_group2, -8);
    lv_obj_set_y(ui_step_group2, -4);

    ui_button_top1 = ui_buttontop_create(ui_watch_analog);
    lv_obj_set_x(ui_button_top1, 90);
    lv_obj_set_y(ui_button_top1, -207);

    ui_button_down1 = ui_buttondown_create(ui_watch_analog);
    lv_obj_set_x(ui_button_down1, 92);
    lv_obj_set_y(ui_button_down1, 203);
