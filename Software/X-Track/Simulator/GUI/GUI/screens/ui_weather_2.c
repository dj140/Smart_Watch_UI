...
void ui_weather_2_screen_init(void)
{
    ...
    lv_obj_set_style_bg_opa(ui_weather_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_button_down4, 88);
    lv_obj_set_y(ui_button_down4, 201);
