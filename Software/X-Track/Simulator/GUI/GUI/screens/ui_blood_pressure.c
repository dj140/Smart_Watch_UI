...
void ui_blood_pressure_screen_init(void)
{
    ...
    lv_obj_set_style_bg_opa(ui_blood_pressure, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(ui_title_group_3, -370);
    ...
    lv_obj_set_y(ui_button_down7, 201);
    ...
    lv_obj_set_x(ui_blood_presure_group1, 6);
    lv_obj_set_y(ui_blood_presure_group1, 42);
    ...
    lv_obj_set_x(ui_pulse_group2, -2);
    lv_obj_set_y(ui_pulse_group2, -3);
    ...
    lv_obj_set_x(ui_blood_presure_group2, 19);
    lv_obj_set_y(ui_blood_presure_group2, -94);
