...
//    lv_obj_t * cui_step_label;
    ui_step_label = lv_label_create(cui_stepgroup);
    lv_obj_set_width(ui_step_label, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_step_label, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_step_label, 2);
    lv_obj_set_y(ui_step_label, -4);
    lv_obj_set_align(ui_step_label, LV_ALIGN_CENTER);
    lv_label_set_text(ui_step_label, "1526");
    lv_obj_set_style_text_color(ui_step_label, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_step_label, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_step_label, &ui_font_Title, LV_PART_MAIN | LV_STATE_DEFAULT);
...
//    children[UI_COMP_STEPGROUP_STEP_LABEL] = ui_step_label;
...
lv_obj_t * ui_stepgroup1_create(lv_obj_t * comp_parent)
{
...
//    lv_obj_t * cui_step_label;
    ui_step_labe2 = lv_label_create(cui_stepgroup);
    lv_obj_set_width(ui_step_labe2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_step_labe2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_step_labe2, 2);
    lv_obj_set_y(ui_step_labe2, -4);
    lv_obj_set_align(ui_step_labe2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_step_labe2, "1526");
    lv_obj_set_style_text_color(ui_step_labe2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_step_labe2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_step_labe2, &ui_font_Title, LV_PART_MAIN | LV_STATE_DEFAULT);

//    lv_obj_t ** children = lv_mem_alloc(sizeof(lv_obj_t *) * _UI_COMP_STEPGROUP_NUM);
//    children[UI_COMP_STEPGROUP_STEPGROUP] = cui_stepgroup;
//    children[UI_COMP_STEPGROUP_STEP] = cui_step;
//    children[UI_COMP_STEPGROUP_STEP_LABEL] = ui_step_labe2;
//    lv_obj_add_event_cb(cui_stepgroup, get_component_child_event_cb, LV_EVENT_GET_COMP_CHILD, children);
//    lv_obj_add_event_cb(cui_stepgroup, del_component_child_event_cb, LV_EVENT_DELETE, children);
//    ui_comp_stepgroup_create_hook(cui_stepgroup);
    return cui_stepgroup;
