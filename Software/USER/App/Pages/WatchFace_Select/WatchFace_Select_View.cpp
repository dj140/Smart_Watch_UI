...
void WatchFace_Select_View::addWatchface(const char* name, const void* src, int index)
{
	...
	lv_obj_set_style_border_width(ui_facePreview, 3, LV_PART_MAIN | LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui_facePreview, lv_color_hex(0x142ABC), LV_PART_MAIN | LV_STATE_DEFAULT);
...
{	
	...
	addWatchface("cxk", ResourcePool::GetImage("cxk_bg"), 0);
	addWatchface("Default", ResourcePool::GetImage("apple_watch"), 1);
	addWatchface("Default", ResourcePool::GetImage("bg_digital_392x392"), 2);
	addWatchface("Default", ResourcePool::GetImage("bg_digital_392x392"), 3);
	addWatchface("Default", ResourcePool::GetImage("bg_digital_392x392"), 4);
	addWatchface("Default", ResourcePool::GetImage("bg_digital_392x392"), 5);
	addWatchface("Default", ResourcePool::GetImage("bg_digital_392x392"), 6);
	addWatchface("Default", ResourcePool::GetImage("bg_digital_392x392"), 7);
